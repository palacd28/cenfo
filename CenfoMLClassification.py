...
for modelo in lista_modelos:
    ...
    print('Test Accuracy :\033[32m \033[01m {:.2f}% \033[30m \033[0m'.format(precision*100))
    ...
    cf_matrix = confusion_matrix(y_test, prediccion)
...
plt.legend(title = 'Total Number of Records: 651,191')
plt.show()
print("")